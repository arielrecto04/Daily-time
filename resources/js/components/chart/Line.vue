...
import { Chart as ChartJS, Title,  LineElement, Tooltip, Legend, PointElement, CategoryScale, LinearScale } from 'chart.js';

ChartJS.register(Title, LineElement, Tooltip, Legend, PointElement, CategoryScale, LinearScale);
