...
import { Chart as ChartJS, Title, ArcElement, Tooltip, Legend, CategoryScale, LinearScale } from 'chart.js';

ChartJS.register(Title, ArcElement, Tooltip, Legend, CategoryScale, LinearScale);
